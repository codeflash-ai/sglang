...
def get_offset(input_layer: str, time_reduction: int):
    ...
    Returns:
        int: offset
    """
    # Precompute input sets for fast membership checks
    # Choose the most likely cases first, to minimize checks
    if input_layer == "conv2d":
        if time_reduction == 4:
            return 3
        elif time_reduction == 6:
            return 1
        elif time_reduction == 8:
            return 7
    elif input_layer == "nemo_conv":
        if time_reduction == 4:
            return 3
        elif time_reduction == 8:
            return 7
