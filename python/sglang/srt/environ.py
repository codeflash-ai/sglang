...
class EnvInt(EnvField):
    def parse(self, value: str) -> int:
        # Avoid unnecessary function call and exception chaining by validating beforehand
        # This avoids exception overhead for non-integer values
        if value and (value[0] == '-' and value[1:].isdigit() or value.isdigit()):
            return int(value)
        else:
