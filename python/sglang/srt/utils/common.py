...
def init_custom_process_group(
    ...
    # Use default timeout directly if not provided (saves attribute lookup)
    ...
    # Compute parameter name only once, avoids repeated conversion/comparison
    ...
    # Avoid creating the empty list and dict at every call site, move to function scope
