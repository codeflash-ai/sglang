...
_cuda_available = getattr(torch, "cuda", None)

_is_cuda_available = _cuda_available is not None and _cuda_available.is_available() if _cuda_available else False
...
def get_device_core_count(device_id: int = 0) -> int:
    if _is_cuda_available:
        return _cuda_available.get_device_properties(device_id).multi_processor_count
