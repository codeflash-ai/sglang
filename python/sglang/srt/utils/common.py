...
def is_nvidia_cublas_cu12_version_ge_12_9():
    ...
    """
    if not hasattr(is_nvidia_cublas_cu12_version_ge_12_9, "_cached_result"):
        try:
            installed_version = version("nvidia-cublas-cu12")
        except PackageNotFoundError:
            is_nvidia_cublas_cu12_version_ge_12_9._cached_result = False
        else:
            is_nvidia_cublas_cu12_version_ge_12_9._cached_result = pkg_version.parse(installed_version) >= pkg_version.parse("12.9")
    return is_nvidia_cublas_cu12_version_ge_12_9._cached_result
